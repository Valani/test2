...
// -------------------------------------------------------------- //
$_['tab_manufacturer'] = 'Бренд';

$_['entry_special_manufacturer'] = 'Фільтр по брендах';
$_['help_special_manufacturer'] = 'Дозволяє фільтрувати товари за стандартними брендам';
