...
$_['text_sku']        	     = 'Артикул (SKU, код бренду) - sku';
$_['text_upc']        	     = 'UPC - upc';
$_['text_ean']        	     = 'EAN - ean';
$_['text_jan']        	     = 'JAN - jan';
...
$_['help_vendorcode']        = 'За замовчуванням артикул (SKU, код бренду)';
...
$_['help_manufacturer']      = 'Відзначте брендів з яких потрібно експортувати пропозиції для Яндекс.Маркет. Якщо не зазначено, то вивантажується весь товар';
