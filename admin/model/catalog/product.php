...
class ModelCatalogProduct extends Model {
	...
	public function getProducts($data = array()) {
        ...
        if (!empty($data['filter_id_1c'])) {
			$sql .= " AND p.id_1c LIKE '%" . $this->db->escape($data['filter_id_1c']) . "%'";
		}
