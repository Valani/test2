...
class ControllerOCTemplatesModuleOctSmartCheckout extends Controller
{
    ...
    public function index() {
        ...
        if (isset($this->request->post['oct_smart_checkout_data']['recommended_poducts']['products'])) {
			$products = $this->request->post['recommended_poducts']['products'];
		}  else {
    ...
    public function exportSettings() {
        ...
        if ($this->validate()) {
            ...
            $output = json_encode(['error' => $this->language->get('error_permission')], JSON_UNESCAPED_UNICODE);
            $this->response->addHeader('Content-Type: application/json');
    ...
    public function addEvent() {
        ...
        if ($this->model_setting_event->getEventByCode('octemplates-showcase-smart-checkout')) {
            return;
        }
        ...
        $events = [
            [
                'code' => 'octemplates-showcase-smart-checkout',
    ...
    public function deleteEvent() {
        ...
        $eventCodes = [
            'octemplates-showcase-smart-checkout',
        ];
    ...
    public function offOldModle() {
        ...
        $this->model_setting_setting->deleteSetting('oct_fastorder');
    ...
    protected function checkOldCheckout(&$data) {
		$this->load->model('setting/event');
        $this->language->load('octemplates/module/oct_fastorder');
